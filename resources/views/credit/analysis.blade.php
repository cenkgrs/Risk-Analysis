...
<head>
    ...
    <title>Kredi Başvuru Analizi &#8211; RISK ANALIZ / RISK ANALYSIS /تحليل المخاطر</title>
    ...
    <link rel="canonical" href="{{ route('credit.personal.get') }}" />
            ...
            <div class="gridContainer content">
                <div id="post-135" class="post-135 page type-page status-publish hentry">
                    <div>
                        ...
                        <form action="{{ route('credit.personal.post') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="name">Firma <span>*</span></label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="name">Firma Kuruluş Tarihi <span>*</span></label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="name">Firma Vergi No <span>*</span></label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="name">Firma Adresi <span>*</span></label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="name">Firma Telefon <span>*</span></label>
                                 ...
                                 <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="company_email">Firma E-Posta <span>*</span></label>
                            ...
                            <h3>Şirket Müdürü | İmza Yetkilisi</h3>

                            <div class="row">

                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="chairman_name">İsim Soyisim <span>*</span></label>
                                        <input type="text" name="chairman_name" id="chairman_name"
                                            value="{{ old('chairman_name') }}" required>
                                        @error('chairman_name')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="chairman_national_id">T.C Kimlik No <span>*</span></label>
                                        <input type="text" name="chairman_national_id" id="chairman_national_id"
                                            value="{{ old('chairman_national_id') }}" required>
                                        @error('chairman_national_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="chairman_document_time">Yetki Belgesi Süresi <span>*</span></label>
                                        <input type="text" name="chairman_document_time" id="chairman_document_time"
                                            value="{{ old('chairman_document_time') }}" required>
                                        @error('chairman_document_time')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="chairman_document_id">Yetki Belgesi <span>*</span></label>
                                        <div class="custom-file-input">
                                            <input type="file" name="chairman_document_id" id="chairman_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('chairman_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                            ...
                            <h3>Başvuru Yapan Kişi</h3>

                            <div class="row">

                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="applicant_name">İsim Soyisim <span>*</span></label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="applicant_phone">Telefon <span>*</span></label>
                                        <input type="test" name="applicant_phone" id="applicant_phone"
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="applicant_email">E-Posta <span>*</span></label>
                                        <input type="mail" name="applicant_email" id="applicant_email"
                            ...
                            <h3>Verilecek Teminatlar</h3>

                            <div class="row">

                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="national_guarantee_document_id">Devlet Garantisi </label>
                                        <div class="custom-file-input">
                                            <input type="file" name="national_guarantee_document_id" id="national_guarantee_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('national_guarantee_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="bank_check_document_id">Banka Çeki </label>
                                        <div class="custom-file-input">
                                            <input type="file" name="bank_check_document_id" id="bank_check_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('bank_check_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="bank_guarantee_document_id">Banka Teminat Mektubu </label>
                                        <div class="custom-file-input">
                                            <input type="file" name="bank_guarantee_document_id" id="bank_guarantee_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('bank_guarantee_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="mortage_deed_document_id">İpotek-Tapu Devri </label>
                                        <div class="custom-file-input">
                                            <input type="file" name="mortage_deed_document_id" id="mortage_deed_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('mortage_deed_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="receivables_document_id">Alacak Temliki </label>
                                        <div class="custom-file-input">
                                            <input type="file" name="receivables_document_id" id="receivables_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('receivables_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="personal_bond_document_id">Şahsi Senet </label>
                                        <div class="custom-file-input">
                                            <input type="file" name="personal_bond_document_id" id="personal_bond_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('personal_bond_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="bond_document_id">Şirket Seneti </label>
                                        <div class="custom-file-input">
                                            <input type="file" name="bond_document_id" id="bond_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('bond_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="company_check_document_id">Şirket Çeki </label>
                                        <div class="custom-file-input">
                                            <input type="file" name="company_check_document_id" id="company_check_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('company_check_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                            ...
                            <h3>Firmanın İştirak Alanları</h3>

                            <div class="row">

                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <select name="involment_area" id="involment_area" required>
                                            <option value="Üretim">Üretim</option>
                                            <option value="İthalat">İthalat</option>
                                            <option value="İhracat">İhracat</option>
                                            <option value="Aracılık-Alım-Satım">Aracılık-Alım-Satım</option>
                                            <option value="Resmi Kurum">Resmi Kurum</option>
                                        </select>
                                        @error('involment_area')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="credit_amount">Kredi Miktarı <span>*</span></label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="credit_currency">Kur <span>*</span></label>
                                        <select name="credit_currency" id="credit_currency" required>
                                            <option value="₺">₺</option>
                                            <option value="$">$</option>
                                            <option value="€">€</option>
                                        </select>
                                        @error('credit_currency')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="credit_term">Süresi (Yıllık) <span>*</span></label>
                                        <input type="text" name="credit_term" id="credit_term"
                                            value="{{ old('credit_term') }}" required>
                                        @error('credit_term')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="guarantee_letter_amount">Teminat Mektubu Miktarı <span>*</span></label>
                                        <input type="text" name="guarantee_letter_amount" id="guarantee_letter_amount"
                                            value="{{ old('guarantee_letter_amount') }}" required>
                                        @error('guarantee_letter_amount')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="guarantee_letter_currency">Kur <span>*</span></label>
                                        <select name="guarantee_letter_currency" id="guarantee_letter_currency" required>
                                            <option value="₺">₺</option>
                                            <option value="$">$</option>
                                            <option value="€">€</option>
                                        </select>
                                        @error('guarantee_letter_currency')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="guarantee_letter_term">Süresi (Yıllık) <span>*</span></label>
                                        <input type="text" name="guarantee_letter_term" id="guarantee_letter_term"
                                            value="{{ old('guarantee_letter_term') }}" required>
                                        @error('guarantee_letter_term')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="lc_amount">LC Miktarı <span>*</span></label>
                                        <input type="text" name="lc_amount" id="lc_amount"
                                            value="{{ old('lc_amount') }}" required>
                                        @error('lc_amount')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="lc_currency">Kur <span>*</span></label>
                                        <select name="lc_currency" id="lc_currency" required>
                                            <option value="₺">₺</option>
                                            <option value="$">$</option>
                                            <option value="€">€</option>
                                        </select>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="lc_term">Süresi (Yıllık) <span>*</span></label>
                                        <input type="text" name="lc_term" id="lc_term"
                                            value="{{ old('lc_term') }}" required>
                                        @error('lc_term')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="leazing">Leazing (Maximum 5 Yıl) <span>*</span></label>
                                        <input type="text" name="leazing" id="leazing"
                                            value="{{ old('leazing') }}" required>
                                        @error('leazing')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="company_requests">Firma Talepleri <span>*</span></label>
                                        <textarea type="text" name="company_requests" id="company_requests"
                                            value="{{ old('company_requests') }}" required></textarea>
                                        @error('company_requests')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="tax_document_id">Vergi Levhası </label>
                                        <div class="custom-file-input">
                                            <input type="file" name="tax_document_id" id="tax_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('tax_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="activity_certificate_document_id">Faaliyet Belgesi <span>*</span></label>
                                        <div class="custom-file-input">
                                            <input type="file" name="activity_certificate_document_id" id="activity_certificate_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('activity_certificate_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="s_circular_document_id">İmza Sirküleri <span>*</span></label>
                                        <div class="custom-file-input">
                                            <input type="file" name="s_circular_document_id" id="s_circular_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('s_circular_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="shareholder_card_document_id">Ortakların Kimlik Fotokopileri <span>*</span></label>
                                        <div class="custom-file-input">
                                            <input type="file" name="shareholder_card_document_id" id="shareholder_card_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('shareholder_card_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="r_regsitration_document_id">Oda Kayıt Belgesi <span>*</span></label>
                                        <div class="custom-file-input">
                                            <input type="file" name="r_regsitration_document_id" id="r_regsitration_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('r_regsitration_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="corporate_tax_document_id">Kurumlar Vergi Beyannamesi <span>*</span></label>
                                        <div class="custom-file-input">
                                            <input type="file" name="corporate_tax_document_id" id="corporate_tax_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('corporate_tax_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="real_estate_document_id">Gayrimenkul bilgileri (işyeri,konut vs tapuları varsa ekspertiz raporları) HACİZ VE İPOTEK YAZILARI
 <span>*</span></label>
                                        <div class="custom-file-input">
                                            <input type="file" name="real_estate_document_id" id="real_estate_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('real_estate_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="contracting_work_document_id">İnşaat taahhüt veya taahhüt işi yapan firmaların devam eden ve biten işler listesi. <span>*</span></label>
                                        <div class="custom-file-input">
                                            <input type="file" name="contracting_work_document_id" id="contracting_work_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('contracting_work_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="bank_collateral_document_id">Çalışılan banka isim ve şubeleri ile bu bankalardaki Limit-risk ve teminat bilgisi içeren tablo <span>*</span></label>
                                        <div class="custom-file-input">
                                            <input type="file" name="bank_collateral_document_id" id="bank_collateral_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('bank_collateral_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="representative_document_id">Firma adına vekaletle işlem yapılacaksa vekaletname ve vekilin kimlik ,telefon ve adres bilgileri <span>*</span></label>
                                        <div class="custom-file-input">
                                            <input type="file" name="representative_document_id" id="representative_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('representative_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="project_list_document_id">Talep edilen kredi yatırım veya proje içinse proje veya yatırım hakkında detay bilgi fizibilite, nakit akış tablosu vb.-BİTEN DEVAM EDEN İŞLERİNİZİN LİSTESİ-HAK EDİŞ TABLOSU <span>*</span></label>
                                        <div class="custom-file-input">
                                            <input type="file" name="project_list_document_id" id="project_list_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('project_list_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="independent_audit_document_id">BAGIMSIZ DENETİM RAPORU <span>*</span></label>
                                        <div class="custom-file-input">
                                            <input type="file" name="independent_audit_document_id" id="independent_audit_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('independent_audit_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="findex_document_id">FİNDEX RİSK RAPORU <span>*</span></label>
                                        <div class="custom-file-input">
                                            <input type="file" name="findex_document_id" id="findex_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('findex_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="ssk_debt_document_id">SSK BORCU YOKTUR YAZISI borc varsa borc dokumu <span>*</span></label>
                                        <div class="custom-file-input">
                                            <input type="file" name="ssk_debt_document_id" id="ssk_debt_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('ssk_debt_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="tax_debt_document_id">VERGİ DAİRESİ BORCU YOKTUR YAZISI borc varsa borc dokumu <span>*</span></label>
                                        <div class="custom-file-input">
                                            <input type="file" name="tax_debt_document_id" id="tax_debt_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('tax_debt_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="group_tax_number_document_id">GRUP ŞİRKET İSİMLERİ VERGİ NUMARALARI <span>*</span></label>
                                        <div class="custom-file-input">
                                            <input type="file" name="group_tax_number_document_id" id="group_tax_number_document_id">
                                            <span class="file-label">Dosya yükleyin...</span>
                                            <button type="button" class="btn-file">Gözat</button>
                                        </div>
                                        @error('group_tax_number_document_id')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
