...
<head>
    ...
    <title>Bireysel Başvuru &#8211; RISK ANALIZ / RISK ANALYSIS /تحليل المخاطر</title>
    ...
    <link rel="canonical" href="https://www.riskanaliz.com.tr/bireysel-basvuru/" />
            ...
            <div class="gridContainer content">
                <div id="post-135" class="post-135 page type-page status-publish hentry">
                    <div>
                        ...
                        <p>Bireysel Başvuru</p>

                        <form action="{{ route('dealer.post') }}" method="POST" enctype="multipart/form-data"
